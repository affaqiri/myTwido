...
(function() {
    var provider = app.data.myTwido = new Everlive({
            offlineStorage: true,
            appId: 'w60a0hyl56agt5gg',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'myTwido_access_token',
...
// START_CUSTOM_CODE_myTwido
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_myTwido